...
namespace ECommerce.Data.Migrations
{
    ...
    [Migration("20260529232139_AddProductAdminOverrideDefaultsAndNullableFlags")]
    partial class AddProductAdminOverrideDefaultsAndNullableFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Entities.Concrete.CartSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsMinimumCartAmountActive")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("MinimumCartAmountMessage")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.ToTable("CartSettings", (string)null);
            ...
            modelBuilder.Entity("ECommerce.Entities.Concrete.MikroCategoryMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MikroAltgrupKod")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("MikroAnagrupKod")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("MikroGrupAciklama")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("MikroMarkaKod")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("MikroAnagrupKod", "MikroAltgrupKod", "MikroMarkaKod")
                        .IsUnique()
                        .HasDatabaseName("IX_MikroCategoryMappings_Unique")
                        .HasFilter("[MikroAltgrupKod] IS NOT NULL AND [MikroMarkaKod] IS NOT NULL");
            ...
            modelBuilder.Entity("ECommerce.Entities.Concrete.MikroSyncState", b =>
                {
                    ...
                    b.Property<long>("LastSyncDurationMs")
                    ...
                    b.HasIndex("SyncType", "Direction")
                        .IsUnique();

                    b.ToTable("MikroSyncStates", (string)null);
                });
