...
(4, N'Pınar Süt 1L', N'Taze tam yağlı süt', 2, 12.50, 50, '/images/pinar-nestle-sut.jpg', 'pinar-sut-1l', 'SUT-001', 'TRY', 1, GETDATE(), GETDATE()),
...
(8, N'Bulgur 1 Kg', N'Pilavlık bulgur', 7, 15.90, 40, '/images/bulgur.png', 'bulgur-1-kg', 'BAK-001', 'TRY', 1, GETDATE(), GETDATE()),
...
PRINT 'Toplam 7 kategori ve 13 ürün oluşturuldu.';
GO
