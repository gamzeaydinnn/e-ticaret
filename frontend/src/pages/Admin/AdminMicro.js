      ...
      <div className="container-fluid p-4">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <div className="d-flex gap-2">
            ...
            <button
              className="btn btn-sm text-white fw-semibold"
              style={{ background: "linear-gradient(135deg, #553c9a, #6b46c1)" }}
            ...
            <button
              className="btn btn-sm text-white fw-semibold"
              style={{ background: "linear-gradient(135deg, #b83280, #d53f8c)" }}
            ...
            <button
              className="btn btn-sm text-white fw-semibold"
              style={{ background: "linear-gradient(135deg, #6b46c1, #805ad5)" }}
          ...
          <div className="col-12 col-xl-6">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-sm btn-outline-secondary" onClick={fetchStocks} disabled={loading}>
                  Yenile
                </button>
              </div>
              <div className="card-body">
                    ...
                    <tbody>
                      {stocks?.length ? (
                        stocks.map((s) => (
                          <tr key={s.productId}>
                            <td>#{s.productId}</td>
                            <td className={Number(s.quantity) <= 0 ? "text-danger" : ""}>{s.quantity}</td>
                          </tr>
                        ))
                      ) : (
                        <tr>
