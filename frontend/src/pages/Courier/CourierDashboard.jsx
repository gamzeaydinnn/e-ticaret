  ...
  const loadOrders = async (courierId) => {
    try {
      ...
      setStats({
        ...
        totalEarnings: completedCount * 15,
        pendingWeightReports: Math.floor(Math.random() * 3),
      });
    } catch (error) {
        ...
        >
          <div className="container-fluid">
            <span className="navbar-brand">
              ...
              Kurye Paneli
              {stats.pendingWeightReports > 0 && (
                <span className="badge bg-danger ms-2 pulse-badge">
                  {stats.pendingWeightReports} ⚠️
                </span>
              )}
            </span>
                  ...
                  {orders.length === 0 ? (
                    ...
                    <div className="row">
                      {orders.slice(0, 4).map((order) => {
                        const hasWeightAlert = Math.random() > 0.7;
                        return (
