...
const SearchAutocomplete = () => {
    ...
    switch (e.key) {
      ...
      case "Enter":
        ...
        if (highlightIndex >= 0 && suggestions[highlightIndex]) {
          navigate(getProductDetailPath(suggestions[highlightIndex]));
          setShowDropdown(false);
          setQuery("");
        } else {
          handleSubmit(e);
  ...
  return (
    <div
      ref={wrapperRef}
      className="search-autocomplete position-relative w-100"
    >
        ...
        >
          {loading ? (
            ...
            <div className="p-3 text-center text-muted">
              <i className="fas fa-search me-2"></i>"{query}" ile eşleşen ürün
              bulunamadı
            </div>
          ) : (
            <>
