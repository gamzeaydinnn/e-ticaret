        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="footer-brand">
              ...
              {footer.showSSLBadge && footer.securityFeatures && (
                <div className="footer-features">
                  {footer.securityFeatures.map((feature, index) => (
                    <div className="footer-feature" key={index}>
                      <i
                        className={`fas ${
                          index === 0
              ...
              {contact.whatsAppNumber && (
                <div className="contact-item">
                  ...
                  >
                    ...
                    <div>
                      <strong>{contact.phoneDisplay || contact.phone}</strong>
                      <br />
