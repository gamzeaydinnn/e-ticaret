  ...
  useEffect(() => {
    getAllProducts()
      ...
      .catch((e) => {
        ...
        // Demo data - API çalışmıyorsa
        setData([
          {
            id: 1,
            name: "Wireless Bluetooth Kulaklık",
            description: "Yüksek kaliteli ses deneyimi sunan wireless kulaklık",
            price: 299.99,
          ...
          },
          {
            ...
            description: "Profesyonel oyuncular için geniş mouse pad",
            price: 89.99,
            categoryId: 4,
            categoryName: "Spor",
            imageUrl: "",
          ...
          },
          {
            ...
            description: "Hızlı şarj destekli dayanıklı kablo",
            price: 49.99,
            categoryId: 1,
            categoryName: "Elektronik",
            imageUrl: "",
          ...
          },
          {
            ...
            description: "Rahat çalışma için ergonomik tasarım",
            price: 899.99,
          ...
          },
          {
            ...
            description: "Anti-slip özellikli kalın yoga matı",
            price: 129.99,
            categoryId: 4,
            categoryName: "Spor",
            imageUrl: "",
          ...
          },
          {
            ...
            description: "Ayarlanabilir parlaklık ve renk sıcaklığı",
            price: 159.99,
          ...
          },
          {
            ...
            description: "RGB backlight ile mekanik gaming klavye",
            price: 549.99,
            categoryId: 1,
            categoryName: "Elektronik",
            imageUrl: "",
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.boxShadow =
                    "0 10px 25px rgba(255, 111, 0, 0.15)";
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                <div className="card-body" style={{ padding: "1.25rem" }}>
                  <div className="text-muted small mb-2">
                    ...
                    {categories.find((cat) => cat.id === p.categoryId)?.name ||
                      "Kategori"}
                  </div>
                      ...
                      {p.discountPercentage > 0 ? (
                        <div>
                          <small className="text-muted text-decoration-line-through">
                            ₺
                            {Number(p.originalPrice || p.price * 1.2).toFixed(
                              2
                            )}
                          </small>
