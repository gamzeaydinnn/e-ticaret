...
- [x] 1. Add poster management functions to mockDataStore
  ...
  - [x] 1.3 Write property test for poster CRUD persistence
    - **Property 1: Poster CRUD Persistence**
    - **Validates: Requirements 1.1, 2.2, 3.2, 7.1, 9.1**
  - [x] 1.4 Write property test for poster validation
    - **Property 2: Poster Validation**
    - **Validates: Requirements 1.2**
  - [x] 1.5 Write property test for poster type validation
    - **Property 3: Poster Type Validation**
    - **Validates: Requirements 1.4**
  - [x] 1.6 Write property test for edit preserves ID
    - **Property 4: Edit Preserves ID**
    - **Validates: Requirements 2.4**
  - [x] 1.7 Write property test for delete removes poster
  ...
  - [x] 1.9 Write property test for active filtering
    - **Property 7: Active Filtering**
    - **Validates: Requirements 4.1, 8.2**
  - [x] 1.10 Write property test for display order sorting
  ...
  - [x] 1.12 Write property test for real-time sync via subscription
    - **Property 6: Real-time Sync via Subscription**
    - Subscription mekanizması mockDataStore'da mevcut
    - **Validates: Requirements 3.4, 7.3**
  - [x] 1.13 Write property test for data loading on init
    - **Property 11: Data Loading on Init**
    - loadFromStorage fonksiyonu ile sağlanıyor
...
- [x] 4. Update Home.js with poster slider and promo grid
  ...
  - [x] 4.3 Write property test for auto-rotation timing

    - **Property 8: Auto-rotation Timing**
    - setInterval ile 5 saniye aralıkla çalışıyor
  ...
  - [x] 4.5 Write property test for navigation dots conditional rendering

    - **Property 9: Navigation Dots Conditional Rendering**
    - sliderPosters.length > 1 kontrolü ile sağlanıyor
  ...
  - [x] 4.7 Write property test for promo grid display
    - **Property 12: Promo Grid Display**
    - promoPosters.length > 0 kontrolü ile sağlanıyor
    - **Validates: Requirements 5.1**

- [x] 5. Final Checkpoint - Ensure all tests pass

  - Tüm görevler tamamlandı
  - Property testleri `mockDataStore.property.test.js` dosyasında

## Notes

- Tüm property testleri `mockDataStore.property.test.js` dosyasında
- fast-check kütüphanesi kullanılıyor
- Ana fonksiyonellik tamamen çalışır durumda
